...
что делиться Х-ами, как это сделано в одном из [постов]({{site.baseurl}}{% post_url 2021-06-25-lxd-gui-audio %}), 
...
постах\[[1]({{site.baseurl}}{% post_url 2021-06-25-lxd-gui-audio %})\]\[[2]({{site.baseurl}}{% post_url 2021-04-19-lxd-lxc %})\].
