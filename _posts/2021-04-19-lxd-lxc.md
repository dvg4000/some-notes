...
```
#### Update 29.06.2024
Как пишут в [интернетах](https://wiki.archlinux.org/title/LXD#Accessing_LXD_as_an_unprivileged_user), добавление
юзера в *lxd* группу, эквивалентно добавлению root-полномочий этому юзеру. Я решил не рисковать и общаться с 
lxd демоном, через **sudo**.
...
#### Update 29.06.2024
Более [удобный](https://blog.simos.info/using-command-aliases-in-lxd-to-exec-a-shell/) алиас для шела:
```sh
